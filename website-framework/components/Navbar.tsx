...
const Navbar = () => {
  return (
  <nav className="top-0 z-30 py-2 px-3 flex relative justify-end pr-10 items-center mt-5">
    
    <Link href="/adel_resume.pdf" className="cursor-pointer left-10 absolute active:brightness-50">
      <div className="text-3xl text-white border-2 border-white rounded-lg py-2 px-5 ml-0 hover:bg-indigo-500">
    ...
    <ul className="hidden h-full gap-16 md:flex flex-row"> 
      {NAV_LINKS.map((link) => (
