...
export const PROJECTS = [ /* shared among homepage projects section and projects page */
	...
	{ title: 'Colligo', key: 'homeless', description: 'Colligo is a feature-rich progressive web app that supercharges Canadian tech job hunting. Routinely scouring 50+ career sites of the biggest tech companies with North American offices.', technologies: 'Next.js, SASS, Django, PostgreSQL, Docker, Supabase, REST APIs', status: 'In Progress', lastUpdate: 'August 2025', href: '/projects', bg: 'COss.webp', projLink: 'https://colligo.careers/', repoLink: 'private', }
]
