...
export const PROJECTS = [ /* shared among homepage projects section and projects page */
  { 
    ...
    description: 'A fully responsive personal website built with a mobile-first approach, emphasizing modular component architecture, semantic HTML, and Tailwind CSS utility patterns to ensure maximum code reusability, performance, and maintainability across devices', 
    technologies: 'React, Next.js, TypeScript, TailwindCSS, UI/UX, SEO, GitHub Actions', 
    status: 'Completed', 
  ...
  { 
    title: 'Moon Tracker', 
    key: 'moon-phase', 
    description: 'An all-in-one night sky tracker with moon phase tracking, anomaly alerts, and year-round star maps', 
    technologies: 'React, Next.js, TypeScript, TailwindCSS, mongoDB, Web Scraping (BeautifulSoup)', 
    status: 'Planning', 
    lastUpdate: 'Apr 2025', 
    href: '/projects',  
    bg: '/PWss.jpg', 
  ...
  { 
    title: 'Spotlight', 
    key: 'maps-extension', 
    description: 'A chrome extension for Google Maps that lets you search for locations on TikTok, Instagram, and YouTube Shorts. The modern way to hunt for hidden gems in your city', 
    ...
    bg: '/CEss.jpg', 
    projLink: 'https://chromewebstore.google.com/detail/spotlight/mfjilmndjelbjimffhogmehpfmjnbmng', 
  ...
  { 
    title: 'Colligo', 
    key: 'homeless', 
    description: 'Colligo is a feature-rich progressive web app that supercharges Canadian tech job hunting. Routinely scouring 50+ career sites of the biggest tech companies with North American offices.', 
    technologies: 'Next.js, SASS, Django, Supabase PostgreSQL, GraphQL (Graphene), REST API', 
    status: 'Ongoing', 
  ...
  { 
    ...
    key: 'CNN', 
    description: 'This project is a real-time American Sign Language (ASL) hand sign recognition system that converts live webcam input into readable English text. It combines computer vision, deep learning, and sequence modeling to produce stable, low-latency text output from continuous hand gestures.', 
    technologies: 'Python, PyTorch, Torchvision, OpenCV, Google Mediapipe, NumPy, Machine Learning, Computer Vision, Neural Networks, Deep Learning, Text and Vision models, Data processing, Data preprocessing, Data Preparation', 
    status: 'Completed', 
